...
async function testAiBot() {
    try {
        ...
        const result1 = await (0, conversations_1.simulateIncoming)({
            phone: phone1,
            text: text1,
            via: 'manual'
        });
        ...
        const conversation1 = await (0, conversations_2.getConversationById)(result1.conversationId);
        ...
        const result2 = await (0, conversations_1.simulateIncoming)({
            phone: phone2,
            text: text2,
            via: 'manual'
        });
        ...
        await new Promise(resolve => setTimeout(resolve, 2000));
        // Obtener la conversación para ver las respuestas
        const conversation2 = await (0, conversations_2.getConversationById)(result2.conversationId);
        ...
        logger_1.default.error('Test failed', { error: msg });
